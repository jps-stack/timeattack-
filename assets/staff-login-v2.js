...
if (errorMessage && new URLSearchParams(window.location.search).get("session") === "expired") {
  errorMessage.textContent = "Tu sesión de Staff venció. Ingresa nuevamente para continuar.";
}
